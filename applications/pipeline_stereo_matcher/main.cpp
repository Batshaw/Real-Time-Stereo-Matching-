...
std::string const& window_name = "NCC stereo matcher";
int window_size_x = 0;
int window_size_y = 0;
...
dsm::StereoMatchingMode active_stereo_matching_mode = dsm::StereoMatchingMode::SIMPLE_NCC_GRAYSCALE_3x8;
...
int main(int argc, char** argv) {
  ...
  std::string reference_disparity_image_path = "";
    ...
    stereo_matcher_ptr = dsm::GPUStereoMatcher::create(context, device_id, 
                                                       cv::Vec2i{input_image_1_bgr_3x8.cols, input_image_1_bgr_3x8.rows}, 
...
void process_frame() {
  ...
  switch(active_stereo_matching_mode) {
      case dsm::StereoMatchingMode::SIMPLE_NCC_GRAYSCALE_3x8: {
          //no prior conversion needed
          stereo_matcher_ptr->process(command_queue, cl_input_buffer_1, cl_input_buffer_2, cl_output_buffer);
          break;
      }
      //case dsm::StereoMatchingMode::SIMPLE_SAD_GRAYSCALE_1x8: {
      ...
      //    stereo_matcher_ptr->process(command_queue, cl_grayscale_1x8_buffer_1, cl_grayscale_1x8_buffer_2, cl_output_buffer);
      //    break;
      //}
      //case dsm::StereoMatchingMode::SIMPLE_SAD_LAB_3x16F: {
      ...
      //    break;
      //}
      //case dsm::StereoMatchingMode::SIMPLE_SAD_LAB_3x32F: {
      //    //convert bgr 3x8 to lab 3x32f
      ...
      //    break;
      //}
      //case dsm::StereoMatchingMode::SIMPLE_ASW_LAB_3x32F: {
      //    //convert bgr 3x8 to lab 3x32f
      //    image_converter_ptr->set_mode(dsm::ConversionMode::BGR_3x8_TO_LAB_3x32F);
      //    //convert image 1 bgr -> lab
      //    image_converter_ptr->process(command_queue, cl_input_buffer_1, cl_lab_image_buffer_1);
...
//
//void on_button_SAD_grayscale_similarity(int state, void* userdata) {
//    active_stereo_matching_mode = dsm::StereoMatchingMode::SIMPLE_SAD_GRAYSCALE_1x8;
//    changed_matching_state = true;
//}
//
//void on_button_SAD_lab_32f_similarity(int state, void* userdata) {
