...
std::shared_ptr<dsm::GPUAdaptiveWeightStereoMatcher> stereo_matcher_ptr = nullptr;
...
int main(int argc, char** argv) {
  ...
  std::string reference_disparity_image_path = "";
    ...
    stereo_matcher_ptr = dsm::GPUAdaptiveWeightStereoMatcher::create(context, device_id,
                                                       cv::Vec2i{input_image_1_bgr_3x8.cols, input_image_1_bgr_3x8.rows}, 
